...
export const tiles: Tile[] = [
  ...
  },
  {
    ...
    name: 'PersonaGen',
    badge: 'Tool',
    tagline: 'Build personas grounded in real data.',
    description: "PersonaGen is The Grovery's persona creation platform. It transforms research, behavioral data, and attitudinal insights into rich, actionable audience profiles — built to inform strategy, not just illustrate it.",
    detail: "Great personas aren't guesses dressed up in a template. PersonaGen structures real discovery inputs into audience archetypes your whole team can actually design and decide from.",
  ...
  },
  {
    ...
    name: 'Personifi',
    badge: 'Tool',
    tagline: 'Personas your clients and agencies can actually use.',
    description: "Personifi takes the personas you've built and turns them into interactive, conversational profiles — giving clients, agencies, and creative teams a way to query, explore, and design for real audience archetypes.",
    detail: "A persona is only as useful as how it gets used. Personifi makes audience intelligence accessible to everyone in the room — not just the strategist who built it.",
